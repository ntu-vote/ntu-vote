...
export class createTablesAndRelations1635299434207 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ntu_vote"."campaigns" ADD CONSTRAINT "FK_0255d03741c3de8b1bd4de0e587" FOREIGN KEY ("cpnr_id") REFERENCES "ntu_vote"."campaign_rules"("cprn_id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
